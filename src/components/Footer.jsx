...
function Footer() {
    return (
        <section className="flex items-center text-white bg-[#333] justify-center">
            <div className="flex flex-col items-center py-10 px-6 md:px-20 lg:px-40">
                {/* Newsletter Section */}
                <div className="flex flex-col items-center justify-center text-center">
                    <h2 className="text-2xl mb-4">Join our listing for exclusive discounts and new recipes</h2>
                    <h3 className="text-xl font-light mb-4">
                        We create new recipes every week and cooking tips
                    </h3>
                    <form className="flex justify-center items-center mt-8 flex-col sm:flex-row">
                        ...
                        <input
                            ...
                            className="px-6 py-2 bg-white text-[#333] border border-[#333] rounded-lg text-lg mb-4 sm:mb-0 sm:mr-4"
                        />
                ...
                <div className="mt-12 md:mt-20 flex flex-wrap justify-center md:justify-between items-start gap-12">
                    {/* About Us Links */}
                    <div className="flex flex-col items-center sm:items-start sm:mr-20 mb-12">
